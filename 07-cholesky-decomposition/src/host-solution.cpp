...
int main(int argc, char** argv) {
    ...
    cl::Buffer buffer_a(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, N * N * sizeof(int), (int*) A, &err);    
    cl::Buffer buffer_res(context, CL_MEM_USE_HOST_PTR | CL_MEM_WRITE_ONLY, N * N * sizeof(int), (int*) L1, &err);
